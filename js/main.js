$(document).ready(function() {
	...
	/* Button to send email with cv */
    $('#mailcvbutton').click(function() {
        window.location = "mailto:hr@lisbondynamics.pt";
    });

	/* Button to send email with cv */
	$('#mailhrbutton').click(function() {
		window.location = "mailto:hr@lisbondynamics.pt";
	});
	...
	/* Button to send email for more info */
    $('#mailhellobutton').click(function() {
        window.location = "mailto:hello@lisbondynamics.pt";
    });
